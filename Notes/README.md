...
│   │   │   │   │   └── 1. Basic CREATE statement.md
│   │   │   │   ├── Data modification language
│   │   │   │   │   ├── 1. Basic INSERT Statement.md
│   │   │   │   │   ├── 2. Basic UPDATE Statement.md
│   │   │   │   │   └── 3. Updating Selected Rows.md
│   │   │   │   ├── Introduction to SQL
│   │   │   │   │   ├── 1. What is SQL.md
│   │   │   │   │   ├── 2. Basic Data Types.md
│   │   │   │   │   ├── 3. Literals.md
│   │   │   │   │   ├── 4. Arithmetic Expressions.md
│   │   │   │   │   └── 5. The NULL Value.md
│   │   │   │   └── Retrieving data
│   │   │   │       ├── 1. Basic SELECT Statement.md
│   │   │   │       ├── 2. SELECT FROM Statement.md
│   │   │   │       ├── 3. Results Ordering.md
│   │   │   │       └── 4. Logic and Comparison Expressions.md
│   │   │   ├── DB Theory
│   │   │   │   ├── Common DB topics
│   │   │   │   │   └── 1. Introduction to Databases.md
│   │   │   │   └── Relational DB theory
│   │   │   │       └── 1. Relational Data Model.md
│   │   │   └── DBMS
│   │   │       └── MySQL
│   │   │           ├── Data definition language
│   │   │           │   ├── 1. Alter Table.md
│   │   │           │   ├── 2. PRIMARY KEY Constraint.md
│   │   │           │   ├── 3. Consistency Constraints.md
│   │   │           │   └── 4. FOREIGN KEY Constraint.md
│   │   │           └── Intro to MySQL.md
│   │   ├── Dev tools
│   │   │   ├── Build Tools
│   │   │   │   ├── Gradle
...
│   │   │   │       ├── 1. Synchronous, Asynchronous, Parallel.md
│   │   │   │       └── 2. Processes and Threads.md
│   │   │   ├── Programming concepts
│   │   │   │   ├── 1. Immutability.md
│   │   │   │   ├── Intro to programming
│   │   │   │   │   ├── 1. Computer Programming.md
...
│           │   │       └── 4. BigDecimal.md
│           │   ├── JDBC
│           │   │   ├── 1. Connecting to a Database with JDBC.md
│           │   │   ├── 2. JDBC Statements.md
│           │   │   ├── 3. JDBC Prepared Statements.md
│           │   │   └── 4. JDBC Transactions.md
│           │   ├── Networking
│           │   │   └── 1. Sockets.md
│           │   ├── Regular expressions
│           │   │   ├── 1. Regexps in Java.md
...
│           │       ├── 1, Serialization Basics.md
│           │       ├── 2. Custom Serialization.md
│           │       ├── 3. Introduction to Gson.md
│           │       └── 4. Customizing JSON with Gson.md
│           ├── Basics
│           │   ├── Control Flow Statements
│           │   │   ├── 1. The for-Loop.md
│           │   │   ├── 2. The while and do-while Loops.md
...
│           │   ├── Functional programming
│           │   │   ├── Functional streams
│           │   │   │   ├── 1. Functional Data Processing with Streams.md
│           │   │   │   ├── 10. Parallel Streams.md
│           │   │   │   ├── 11. Grouping Collectors.md
│           │   │   │   ├── 2. Stream Filtering.md
│           │   │   │   ├── 3. Map and flatMap.md
│           │   │   │   ├── 4. Reduction Methods.md
│           │   │   │   ├── 5. Collectors.md
│           │   │   │   ├── 6. Infinite Streams.md
│           │   │   │   ├── 7. Taking Elements.md
│           │   │   │   ├── 8. Streams of Primitives.md
│           │   │   │   └── 9. Stream Pipelines.md
│           │   │   └── Functions
│           │   │       ├── 1. Lambda Expressions.md
│           │   │       ├── 2. Method References.md
│           │   │       ├── 3. Functional Interfaces.md
│           │   │       ├── 4. Standard Functional Interfaces.md
│           │   │       ├── 5. Optional.md
│           │   │       └── 6. Function Composition.md
│           │   ├── Generic programming
│           │   │   ├── Generics essentials
│           │   │   │   ├── 1. Introduction to Generic Programming.md
│           │   │   │   ├── 2. Generics and Object.md
│           │   │   │   ├── 3. Generic Methods.md
│           │   │   │   ├── 4. Type Bounds.md
│           │   │   │   └── 5. Wildcards.md
│           │   │   └── Generics internals
│           │   │       ├── 1. Type Erasure.md
...
│           │   │       ├── Annotations
│           │   │       │   ├── 1. Annotations Basics.md
│           │   │       │   ├── 2. Detecting Annotations.md
│           │   │       │   └── 3. Custom Annotations and Types of Annotations.md
│           │   │       ├── Enumerations
│           │   │       │   ├── 1. Enum.md
│           │   │       │   ├── 2. Enums in Java.md
│           │   │       │   └── 3. Fields and Methods in Enum.md
...
│           ├── Errorless code
│           │   ├── Debugging
│           │   │   ├── 1. Debugging Techniques.md
│           │   │   ├── 2. Debugging Simple Constructs.md
│           │   │   └── 3. Advanced Debugger Features.md
│           │   ├── Exception handling
│           │   │   ├── 1. What Is An Exception.md
│           │   │   ├── 2. NPE.md
│           │   │   ├── 3. Array Exceptions.md
...
│           │   │   └── 8. Try With Resources.md
│           │   ├── Logging
│           │   │   ├── 1. Standard Logger.md
│           │   │   ├── 2. Introduction to Logging in Java.md
│           │   │   └── 3. Logback.md
│           │   └── Testing tools and libraries
│           │       ├── 1. Unit Testing With JUnit.md
│           │       ├── 2. Test Lifecycle Annotations.md
...
│           │   │   ├── 1. Running Programs on Your Computer.md
│           │   │   ├── 2. Call Stack.md
│           │   │   ├── 3. Class Files and Bytecode.md
│           │   │   ├── 4. Class Loader.md
│           │   │   ├── 5. Object Interning.md
│           │   │   └── 6. Stack Trace.md
│           │   └── Reflection
│           │       ├── 1. Reflection Basics.md
│           │       ├── 2. Retrieving Class Instances.md
│           │       ├── 3. Dealing with Modifiers.md
│           │       └── 4. Manipulating Fields and Methods.md
│           └── Working with data
│               ├── Arrays
│               │   ├── 1. Array.md
│               │   ├── 2. Iterating Over Arrays.md
...
│               │       ├── 5. The Map Interface.md
│               │       ├── 6. Comparator.md
│               │       ├── 7. The Utility Class Collections.md
│               │       └── 8. Iterator and Iterable.md
│               ├── File processing
│               │   ├── 1. Files.md
│               │   ├── 2. Writing Files.md
│               │   ├── 3. Reading Files.md
...
│               └── Multithreading
│                   ├── Basics of threads
│                   │   ├── 1. Threads as Objects.md
│                   │   ├── 2. Custom Threads.md
│                   │   ├── 3. Thread Management.md
│                   │   ├── 4. Exceptions in Threads.md
│                   │   └── 5. States of a Thread.md
│                   ├── Synchronization
│                   │   ├── 1. Shared Data.md
│                   │   └── 2. Thread Synchronization.md
│                   ├── Task processing
│                   │   ├── 1. Executors.md
│                   │   ├── 2. Interruptions.md
│                   │   ├── 3. Callable and Future.md
│                   │   └── 4. Timers.md
│                   └── Thread-safe collections
│                       ├── 1. Collections and Thread-Safety.md
│                       ├── 2. CopyOnWriteArrayList.md
│                       ├── 3. Concurrent Queues.md
│                       └── 4. Thread-safe Maps.md
├── Math
│   └── Computational Math
│       └── Numeral Systems
│           ├── 1. Binary numbers.md
...
│           ├── 4. Hexadecimal Numbers.md
│           ├── 5. Decimal to Binary: Fractions.md
│           └── 6. Binary Arithmetic.md
└── README.md

121 directories, 298 files
